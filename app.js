...
// Use Object.keys to populate brands
...
function showDetails() {
  ...
  if (selectedBrand && selectedModel && mobiles[selectedBrand][selectedModel]) {
    ...
    outputDiv.innerHTML = `
      ...
      <strong>Processor:</strong> ${details.processor}<br>
      <strong>RAM:</strong> ${details.memory.ram} GB<br>
      <strong>Storage:</strong> ${details.memory.storage} GB<br>
      <strong>Battery:</strong> ${details.battery} mAh<br>
      <strong>Operating System:</strong> ${details.operatingSystem}<br>
      <strong>Special Features:</strong> ${details.specialFeatures.join(", ")}
    `;
  } else {
    outputDiv.textContent = "Please select a valid brand and model.";
  }
}
